...
export async function GET(request) {
  ...
  try {
    const manifestRes = await fetch(siteUrl + '/manifest-dark.json?v=' + Date.now());
...
<rss version="2.0">
<channel>
  <title>Second Nature — Divergent</title>
  <link>${siteUrl}/</link>
  <description>Records from a divergent branch of the archive, as indexed. No further explanation provided at this access tier.</description>
...
${items}
    ...
    return new Response('<?xml version="1.0" encoding="UTF-8"?><rss version="2.0"><channel><title>Second Nature — Divergent</title><description>feed temporarily unavailable</description></channel></rss>', {
      status: 200,
